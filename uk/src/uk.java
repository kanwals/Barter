...
public class uk extends javax.swing.JFrame {
    ...
    private void refreshbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        try {
            res.clear();
            dos.writeBytes("UK DISTRIBUTION\r\n");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "NOT CONNECTED. RESTART APPLICATION AND CONNECT AGAIN.");
        }
    }                                             
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if(user.equals("uk")&&pass.equals("edcuk123")){
        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(uk.this, "Either: \n1)INVALID IP\n2)SERVER NOT RUNNING\n3)INTERNET DISCONNECTED", "ERROR", JOptionPane.OK_OPTION);
                    connectbutton.setEnabled(true);
                }
                if (connected_flag == true) {
                    JOptionPane.showMessageDialog(uk.this, "Connected to server! :)");
                    setTitle("UK's IP: " + s.getLocalAddress().getHostAddress());
                    connectbutton.setEnabled(false);
                    dos.writeBytes("UK\r\n");//for server's table
                }
                while (true) {
