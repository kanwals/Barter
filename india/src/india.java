...
public class india extends javax.swing.JFrame {
    ...
    private void txtmachineryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtmachineryActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtmachineryActionPerformed
    ...
    private void txtmetalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtmetalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtmetalActionPerformed

    private void connectbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectbuttonActionPerformed
        // TODO add your handling code here:
        try {
            obj = new india.client();
    ...
    private void refreshbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshbuttonActionPerformed
        ...
        try {
            res.clear();
            dos.writeBytes("INDIA DISTRIBUTION\r\n");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "NOT CONNECTED. RESTART APPLICATION AND CONNECT AGAIN.");
        }
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbuttonActionPerformed
        ...
        if(user.equals("india")&&pass.equals("edcindia123")){
        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(india.this, "Either: \n1)INVALID IP\n2)SERVER NOT RUNNING\n3)INTERNET DISCONNECTED", "ERROR", JOptionPane.OK_OPTION);
                    connectbutton.setEnabled(true);
                }
                if (connected_flag == true) {
                    JOptionPane.showMessageDialog(india.this, "Connected to server! :)");
                    setTitle("INDIA's IP: " + s.getLocalAddress().getHostAddress());
                    connectbutton.setEnabled(false);
                    dos.writeBytes("INDIA\r\n");//for server's table
                }
                while (true) {
