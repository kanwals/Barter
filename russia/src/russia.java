...
public class russia extends javax.swing.JFrame {
    ...
    private void refreshbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        try {
            res.clear();
            dos.writeBytes("RUSSIA DISTRIBUTION\r\n");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "NOT CONNECTED. RESTART APPLICATION AND CONNECT AGAIN.");
        }
    }                                             
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if(user.equals("russia")&&pass.equals("edcrussia123")){
        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(russia.this, "Either: \n1)INVALID IP\n2)SERVER NOT RUNNING\n3)INTERNET DISCONNECTED", "ERROR", JOptionPane.OK_OPTION);
                    connectbutton.setEnabled(true);
                }
                if (connected_flag == true) {
                    JOptionPane.showMessageDialog(russia.this, "Connected to server! :)");
                    setTitle("RUSSIA's IP: " + s.getLocalAddress().getHostAddress());
                    connectbutton.setEnabled(false);
                    dos.writeBytes("RUSSIA\r\n");//for server's table
                }
                while (true) {
