...
public class germany extends javax.swing.JFrame {
    ...
    private void refreshbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        try {
            res.clear();
            dos.writeBytes("GERMANY DISTRIBUTION\r\n");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "NOT CONNECTED. RESTART APPLICATION AND CONNECT AGAIN.");
        }
    }                                             
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if(user.equals("germany")&&pass.equals("edcgermany123")){
        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(germany.this, "Either: \n1)INVALID IP\n2)SERVER NOT RUNNING\n3)INTERNET DISCONNECTED", "ERROR", JOptionPane.OK_OPTION);
                    connectbutton.setEnabled(true);
                }
                if (connected_flag == true) {
                    JOptionPane.showMessageDialog(germany.this, "Connected to server! :)");
                    setTitle("GERMANY's IP: " + s.getLocalAddress().getHostAddress());
                    connectbutton.setEnabled(false);
                    dos.writeBytes("GERMANY\r\n");//for server's table
                }
                while (true) {
