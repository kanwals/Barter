...
public class kuwait extends javax.swing.JFrame {
    Thread t;
    client obj;
    ...
    private void refreshbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        try {
            res.clear();
            dos.writeBytes("KUWAIT DISTRIBUTION\r\n");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "NOT CONNECTED. RESTART APPLICATION AND CONNECT AGAIN.");
        }
    }                                             
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if(user.equals("kuwait")&&pass.equals("edckuwait123")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kuwait.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(kuwait.this, "Either: \n1)INVALID IP\n2)SERVER NOT RUNNING\n3)INTERNET DISCONNECTED", "ERROR", JOptionPane.OK_OPTION);
                    connectbutton.setEnabled(true);
                }
                if (connected_flag == true) {
                    JOptionPane.showMessageDialog(kuwait.this, "Connected to server! :)");
                    setTitle("KUWAIT's IP: " + s.getLocalAddress().getHostAddress());
                    connectbutton.setEnabled(false);
                    dos.writeBytes("KUWAIT\r\n");//for server's table
                }
                while (true) {
